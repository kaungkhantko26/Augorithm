...
- Windows 10/11 x64: `Augorithm-1.3.3-x64.exe`
- Apple-silicon macOS: `Augorithm-1.3.3-arm64.zip`

## Install on Windows

1. Download `Augorithm-1.3.3-x64.exe` from Releases.
...
1. Download `Augorithm-1.3.3-arm64.zip` from Releases.
